...
#define TRAFFIC_LIGHTS			(*((volatile unsigned long *)0x400050FC)) // making PB5,PB4,PB3,PB2,PB1,PB0 =WR,WY,WG,SR,SY,SG
#define PEDESTRIAN_LIGHTS		(*((volatile unsigned long *)0x40025028)) // making PF3=WG  and PF1=WR
#define SENSORS							(*((volatile unsigned long *)0x4002401C)) // making PE2,PE1,PE0 = WS,SS,WS
...
typedef const struct State Stype;
	...
	Stype FSM[11]={
		...
		{0x14,0x02,10,{1,0,2,2,4,4,2,2}},
		{0x21,0x02,20,{2,3,2,3,3,3,3,3}},
		{0x22,0x02,10,{3,0,2,0,4,0,4,4}},
